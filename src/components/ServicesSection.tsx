        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
          {services.map((svc, i) => {
            ...
            return (
              <motion.div
                key={svc.title}
                className="glass p-6 md:p-7 rounded-2xl flex flex-col gap-5 hover:bg-white/12 hover:border-[#D4A373]/25 transition-colors duration-300 group cursor-pointer"
              ...
              >
                {/* Icon container */}
                <div className="w-11 h-11 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center group-hover:bg-[#D4A373]/15 group-hover:border-[#D4A373]/30 transition-colors">
                  <Icon className="w-5 h-5 text-white/70 group-hover:text-[#D4A373]" />
                </div>

                {/* Number */}
                <span className="text-[#D4A373]/70 font-normal text-5xl leading-none select-none">
                  0{i + 1}
                </span>
